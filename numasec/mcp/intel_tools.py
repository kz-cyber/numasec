...
These tools give the host LLM (Claude, GPT, etc.) access to numasec's
...
def _lookup_cwe(cwe_id: str) -> dict[str, Any] | None:
    ...
    from numasec.standards.owasp import get_owasp_category
...
def _classify_finding_owasp(finding: Any) -> set[str]:
    ...
    from numasec.standards.owasp import CWE_OWASP_MAP
