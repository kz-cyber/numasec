...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/numasec/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/numasec...\n")
...
console.log("Fetching npm all-time downloads for numasec...\n")
const npmDownloads = await fetchNpmDownloads("numasec")
