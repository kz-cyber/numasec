...
- PR #13942: https://github.com/anomalyco/numasec/pull/13942

## Do Not Translate (Locale Additions)

- `Numasec` (preserve casing in prose; keep `numasec` only when it is part of commands, package names, paths, or code)
- `Numasec Zen`
- `Numasec CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `numasec` in prose when referring to the product name; use `Numasec`
