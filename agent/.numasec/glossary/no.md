...
- PR #10018: https://github.com/anomalyco/numasec/pull/10018
- PR #12935: https://github.com/anomalyco/numasec/pull/12935

## Do Not Translate (Locale Additions)

- `Numasec` (preserve casing in prose; keep `numasec` only in commands, package names, paths, or code)
- `Numasec CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
