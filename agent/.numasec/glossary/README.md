...
Use this folder for locale-specific translation guidance that supplements `.numasec/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/numasec/pull/12345

## Do Not Translate (Locale Additions)

- `Numasec` (preserve casing)
