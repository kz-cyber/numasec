...
- PR #15835: https://github.com/anomalyco/numasec/pull/15835

## Do Not Translate (Locale Additions)

- `Numasec` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `numasec` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Numasec` in prose, `numasec` only for exact technical identifiers
...
- Avoid changing `numasec` to `Numasec` inside commands, URLs, package names, or code literals
