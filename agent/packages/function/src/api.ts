...
export default new Hono<{ Bindings: Env }>()
  ...
  .post("/exchange_github_app_token", async (c) => {
    const EXPECTED_AUDIENCE = "numasec-github-action"
  ...
  /**
   * Used by the GitHub action to get GitHub installation access token given user PAT token (used when testing `numasec github run` locally)
   */
  ...
  /**
   * Used by the numasec CLI to check if the GitHub app is installed
   */
