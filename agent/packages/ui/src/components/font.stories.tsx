...
const docs = `### Overview
Loads Numasec typography assets and mono nerd fonts.
...
export const Basic = {
  render: () => (
    <div style={{ display: "grid", gap: "8px" }}>
      <mod.Font />
      <div style={{ "font-family": "var(--font-family-sans)" }}>Numasec Sans Sample</div>
      <div style={{ "font-family": "var(--font-family-mono)" }}>Numasec Mono Sample</div>
    </div>
  ),
}
