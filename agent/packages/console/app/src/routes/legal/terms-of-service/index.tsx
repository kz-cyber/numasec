...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Numasec | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Numasec terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Numasec. Please read on to learn the rules and restrictions that govern your use of
                Numasec&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Numasec," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://numasec.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-numasec">What is Numasec?</h2>
              <p>
                Numasec is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Numasec Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Numasec enables you to
              ...
              <p>
                ...
                our site located at numasec.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Numasec takes the privacy of its users very seriously. For the current Numasec Privacy Policy, please
                click here{" "}
                <a href="https://numasec.ai/legal/privacy-policy">https://numasec.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Numasec?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Numasec;
                </li>
                <li>
              ...
              <p>
                If you use Numasec with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Numasec. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Numasec has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-numasec-ever-change-the-services">Will Numasec ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://numasec.ai/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://numasec.ai/auth">https://numasec.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://numasec.ai/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                Numasec is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Numasec has the sole right to decide whether you are
              ...
              <p>
                Numasec and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Numasec and all such
                parties together, the "Numasec Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Numasec Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Numasec Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY NUMASEC (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                NUMASEC PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO NUMASEC IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Numasec Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Numasec's prior written
              ...
              <p>
                ...
                disputes and claims with Numasec and limits the manner in which you can seek relief from Numasec. Both
                you and Numasec acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Numasec's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Numasec will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Numasec will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Numasec may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND NUMASEC WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and Numasec are instead choosing to have claims and disputes resolved by
                ...
                you and Numasec over whether to vacate or enforce an arbitration award, YOU AND NUMASEC WAIVE ALL
              ...
              <p>
                ...
                Numasec is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Numasec to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Numasec agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Numasec may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Numasec agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Numasec, and
                ...
                are not an employee, agent, partner, or joint venture of Numasec, and you do not have any authority of
                any kind to bind Numasec in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Numasec
