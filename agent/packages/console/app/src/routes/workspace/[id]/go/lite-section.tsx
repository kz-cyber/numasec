...
import { Database, eq, and, isNull } from "@numasec/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@numasec/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#numasec-go")} target="_blank" rel="noopener noreferrer">
