    ...
    <main data-page="home">
      ...
      <div data-component="content">
          ...
          <div data-slot="right">
            <button data-copy data-slot="command">
              <span>
                ...
                <span data-slot="highlight">numasec.ai/install</span>
                <span> | bash</span>
              </span>
              <CopyStatus />
            </button>
        ...
        <section data-component="install">
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                npm install -g <strong>numasec</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                bun install -g <strong>numasec</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                brew install <strong>numasec</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
          <div data-component="method">
            ...
            <button data-copy data-slot="button">
              <span>
                paru -S <strong>numasec-bin</strong>
              </span>
              <CopyStatus />
            </button>
          </div>
        ...
        <footer data-component="footer">
          <div data-slot="cell">
            <a href="https://x.com/numasec">{i18n.t("footer.x")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://github.com/anomalyco/numasec">{i18n.t("footer.github")}</a>
          </div>
          <div data-slot="cell">
            <a href="https://numasec.ai/discord">{i18n.t("footer.discord")}</a>
          </div>
        </footer>
      </div>
