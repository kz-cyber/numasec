...
import compareVideo from "../../asset/lander/numasec-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/numasec-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="numasec:auth" content={loggedin() ? "true" : "false"} />
