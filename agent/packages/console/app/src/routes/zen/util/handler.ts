...
import { and, Database, eq, isNull, lt, or, sql } from "@numasec/console-core/drizzle/index.js"
import { KeyTable } from "@numasec/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@numasec/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@numasec/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@numasec/console-core/util/date.js"
import { Identifier } from "@numasec/console-core/identifier.js"
import { Billing } from "@numasec/console-core/billing.js"
import { Actor } from "@numasec/console-core/actor.js"
import { WorkspaceTable } from "@numasec/console-core/schema/workspace.sql.js"
import { ZenData } from "@numasec/console-core/model.js"
import { Subscription } from "@numasec/console-core/subscription.js"
import { BlackData } from "@numasec/console-core/black.js"
import { UserTable } from "@numasec/console-core/schema/user.sql.js"
import { ModelTable } from "@numasec/console-core/schema/model.sql.js"
import { ProviderTable } from "@numasec/console-core/schema/provider.sql.js"
...
import { LiteData } from "@numasec/console-core/lite.js"
import { Resource } from "@numasec/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-numasec-session") ?? ""
    const requestId = input.request.headers.get("x-numasec-request") ?? ""
    const projectId = input.request.headers.get("x-numasec-project") ?? ""
    const ocClient = input.request.headers.get("x-numasec-client") ?? ""
    logger.metric({
      is_stream: isStream,
      session: sessionId,
      request: requestId,
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-numasec-request")
          headers.delete("x-numasec-session")
          headers.delete("x-numasec-project")
          headers.delete("x-numasec-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://numasec.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://numasec.ai/workspace/${authInfo.workspaceID}/members`
