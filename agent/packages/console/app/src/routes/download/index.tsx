...
import desktopAppIcon from "../../asset/lander/numasec-desktop-icon.png"
      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://numasec.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>numasec.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g numasec")}>
                <code>
                  npm i -g <strong>numasec</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g numasec")}>
                <code>
                  bun add -g <strong>numasec</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/numasec")}>
                <code>
                  brew install <strong>anomalyco/tap/numasec</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S numasec")}>
                <code>
                  paru -S <strong>numasec</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask numasec-desktop")}>
                <code>
                  brew install --cask <strong>numasec-desktop</strong>
                </code>
                <CopyStatus />
              </button>
