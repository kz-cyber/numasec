...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | numasec",
  "notFound.heading": "404 - Sayfa bulunamadı",
  "notFound.home": "Ana sayfa",
  "notFound.docs": "Dokümantasyon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "numasec açık logo",
  "notFound.logoDarkAlt": "numasec koyu logo",
  ...
  "app.meta.description": "Numasec - Açık kaynaklı kodlama ajanı.",

  "home.title": "Numasec | Açık kaynaklı yapay zeka kodlama ajanı",

  "temp.title": "numasec | Terminal için geliştirilmiş yapay zeka kodlama ajanı",
  ...
  "temp.feature.zen.beforeLink": "numasec tarafından sağlanan ",
  ...
  "temp.screenshot.caption": "numasec TUI ve tokyonight teması",
  "temp.screenshot.alt": "tokyonight temalı numasec TUI",
  "temp.logoLightAlt": "numasec açık logo",
  "temp.logoDarkAlt": "numasec koyu logo",
  ...
  "home.what.title": "Numasec nedir?",
  "home.what.body":
    "Numasec, terminalinizde, IDE'nizde veya masaüstünde kod yazmanıza yardım eden açık kaynaklı bir ajandır.",
  ...
  "home.growth.body":
    "GitHub'da <strong>{{stars}}</strong>+ yıldız, <strong>{{contributors}}</strong> katılımcı ve <strong>{{commits}}</strong>+ commit ile Numasec, her ay <strong>{{monthlyUsers}}</strong>+ geliştirici tarafından kullanılıyor ve güveniliyor.",
  ...
  "home.privacy.body":
    "Numasec kodunuzu veya bağlam verilerinizi saklamaz; bu sayede gizliliğe duyarlı ortamlarda çalışabilir.",
  "home.privacy.learnMore": "Hakkında daha fazla bilgi:",
  "home.privacy.link": "gizlilik",

  "home.faq.q1": "Numasec nedir?",
  "home.faq.a1":
    "Numasec, herhangi bir AI modeliyle kod yazmanıza ve çalıştırmanıza yardım eden açık kaynaklı bir ajandır. Terminal arayüzü, masaüstü uygulaması veya IDE uzantısı olarak kullanılabilir.",
  "home.faq.q2": "Numasec'u nasıl kullanırım?",
  "home.faq.a2.before": "Başlamanın en kolay yolu",
  "home.faq.a2.link": "girişi okumaktır",
  "home.faq.q3": "Numasec için ek AI aboneliklerine ihtiyacım var mı?",
  "home.faq.a3.p1": "Şart değil. Numasec, hesap açmadan kullanabileceğiniz ücretsiz modellerle gelir.",
  ...
  "home.faq.a3.p3": "Zen'i öneriyoruz, ancak Numasec OpenAI, Anthropic, xAI gibi popüler sağlayıcılarla da çalışır.",
  "home.faq.a3.p4.beforeLocal": "Hatta",
  "home.faq.a3.p4.localLink": "yerel modellerinizi bağlayabilirsiniz",
  "home.faq.q4": "Mevcut AI aboneliklerimi Numasec ile kullanabilir miyim?",
  "home.faq.a4.p1":
    "Evet. Numasec tüm büyük sağlayıcıların aboneliklerini destekler. Claude Pro/Max, ChatGPT Plus/Pro veya GitHub Copilot kullanabilirsiniz.",
  "home.faq.q5": "Numasec'u sadece terminalde mi kullanabilirim?",
  "home.faq.a5.beforeDesktop": "Artık hayır! Numasec artık sizin bu cihazlarınıza",
  "home.faq.a5.desktop": "masaüstü",
  "home.faq.a5.and": "ve",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Numasec ne kadar?",
  "home.faq.a6":
    "Numasec %100 ücretsizdir. Ayrıca ücretsiz model setiyle gelir. Başka bir sağlayıcı bağlarsanız ek maliyetler olabilir.",
  ...
  "home.faq.q8": "Numasec açık kaynak mı?",
  "home.faq.a8.p1": "Evet, Numasec tamamen açık kaynaktır. Kaynak kodu",
  "home.faq.a8.p2": "'da",
  ...
  "home.zenCta.body":
    "Zen, Numasec'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",
  "home.zenCta.link": "Zen hakkında",

  "zen.title": "Numasec Zen | Kodlama ajanları için güvenilir, optimize edilmiş modellerin seçilmiş seti",
  "zen.hero.title": "Kodlama ajanları için güvenilir, optimize modeller",
  "zen.hero.body":
    "Zen, Numasec'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",

  "zen.faq.q1": "Numasec Zen nedir?",
  "zen.faq.a1":
    "Zen, Numasec ekibi tarafından oluşturulan ve kodlama ajanları için test edilip benchmark edilen seçilmiş bir AI model setidir.",
  ...
  "zen.faq.a3":
    "Zen kâr amaçlı değildir. Zen, model sağlayıcılarının maliyetlerini size yansıtır. Zen'in kullanımı arttıkça Numasec daha iyi fiyatlar pazarlayabilir ve bunları size yansıtabilir.",
  ...
  "zen.faq.a4.p3":
    "Maliyetleri karşılamak için Numasec, $20 bakiye yüklemesi başına yalnızca $1.23 tutarında küçük bir ödeme işleme ücreti ekler.",
  ...
  "zen.faq.a8":
    "Zen Numasec ile harika çalışır, ama Zen'i herhangi bir ajan ile kullanabilirsiniz. Tercih ettiğiniz kodlama ajanında kurulum talimatlarını izleyin.",
  ...
  "zen.problem.subtitle": "Bu sorunu yalnızca Numasec kullanıcıları için değil, herkes için düzeltiyoruz.",
  ...
  "zen.how.body": "Zen'i Numasec ile kullanmanızı önersek de, Zen'i herhangi bir ajan ile kullanabilirsiniz.",
  ...
  "go.title": "Numasec Go | Herkes için düşük maliyetli kodlama modelleri",
  "go.meta.description":
  ...
  "go.problem.body":
    "Numasec deneyimini mümkün olduğunca çok kişiye ulaştırmaya odaklandık. Numasec Go düşük maliyetli bir aboneliktir: İlk ay $5, sonrasında ayda 10$. Cömert limitler ve en yetenekli açık kaynak modellere güvenilir erişim sağlar.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go ilk ay $5, sonrasında ayda 10$ fiyatıyla başlar. Numasec veya herhangi bir ajanla kullanabilirsiniz.",
  ...
  "black.meta.title": "Numasec Black | Dünyanın en iyi kodlama modellerine erişin",
  "black.meta.description": "Numasec Black abonelik planlarıyla Claude, GPT, Gemini ve daha fazlasına erişin.",
  "black.hero.title": "Dünyanın en iyi kodlama modellerine erişin",
  "black.hero.subtitle": "Claude, GPT, Gemini ve daha fazlası dahil",
  "black.title": "Numasec Black | Fiyatlandırma",
  ...
  "black.workspace.title": "Numasec Black | Çalışma Alanı Seç",
  "black.workspace.selectPlan": "Bu plan için bir çalışma alanı seçin",
  "black.workspace.name": "Çalışma Alanı {{n}}",
  "black.subscribe.title": "Numasec Black'e Abone Ol",
  ...
  "black.subscribe.success.title": "Numasec Black bekleme listesindesiniz",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman numasec ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve numasec seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "numasec'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "numasec hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir numasec Gateway API anahtarı oluşturun",
  ...
  "workspace.black.subscription.message": "Aylık ${{plan}} karşılığında Numasec Black'e abonesiniz.",
  ...
  "workspace.black.waitlist.joined": "Aylık ${{plan}} Numasec Black planı için bekleme listesindesiniz.",
  "workspace.black.waitlist.ready": "Sizi ayda {{plan}} $ tutarındaki Numasec Black planına kaydetmeye hazırız.",
  ...
  "workspace.lite.subscription.message": "Numasec Go abonesisiniz.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go modellerini kullanmak için numasec yapılandırmanızda "Numasec Go"\'yu sağlayıcı olarak seçin.',
  "workspace.lite.black.message":
    "Şu anda Numasec Black abonesisiniz veya bekleme listesindesiniz. Go'ya geçmek istiyorsanız lütfen önce aboneliğinizi iptal edin.",
  "workspace.lite.other.message":
    "Bu çalışma alanındaki başka bir üye zaten Numasec Go abonesi. Çalışma alanı başına yalnızca bir üye abone olabilir.",
  "workspace.lite.promo.description":
    "Numasec Go {{price}} fiyatından başlar, sonrasında ayda 10$ olur ve cömert kullanım limitleriyle popüler açık kodlama modellerine güvenilir erişim sağlar.",
  ...
  "download.title": "Numasec | İndir",
  "download.meta.description": "Numasec'u macOS, Windows ve Linux için indirin",
  "download.hero.title": "Numasec'u İndir",
  ...
  "download.section.extensions": "Numasec Eklentileri",
  "download.section.integrations": "Numasec Entegrasyonları",
  ...
  "download.faq.a3.beforeLocal":
    "Tam olarak değil, ama muhtemelen. Numasec'u ücretli bir sağlayıcıya bağlamak istiyorsanız bir AI aboneliği gerekir, ancak",
  ...
  "download.faq.a3.afterZen":
    " kullanmaya teşvik ediyoruz, ancak Numasec OpenAI, Anthropic, xAI vb. gibi tüm popüler sağlayıcılarla çalışır.",

  "download.faq.a5.p1": "Numasec %100 ücretsizdir.",
  "download.faq.a5.p2.beforeZen":
    "Ek maliyetler, bir model sağlayıcısına olan aboneliğinizden gelir. Numasec herhangi bir model sağlayıcısıyla çalışır, ancak",
  "download.faq.a5.p2.afterZen": " kullanmanızı öneririz.",

  "download.faq.a6.p1":
    "Verileriniz ve bilginiz yalnızca Numasec'da paylaşılabilir bağlantılar oluşturduğunuzda saklanır.",
  "download.faq.a6.p2.beforeShare": "Daha fazla bilgi:",
  "download.faq.a6.shareLink": "paylaşım sayfaları",

  "enterprise.title": "Numasec | Kurumunuz için kurumsal çözümler",
  "enterprise.meta.description": "Kurumsal çözümler için Numasec ile iletişime geçin",
  "enterprise.hero.title": "Kodunuz size aittir",
  "enterprise.hero.body1":
    "Numasec, hiçbir veri veya bağlam saklamadan ve lisans kısıtlamaları ya da sahiplik iddiaları olmadan kuruluşunuzun içinde güvenli şekilde çalışır. Ekibinizle bir deneme başlatın, ardından SSO'nuz ve dahili AI geçidiniz ile entegre ederek tüm kuruluşunuzda devreye alın.",
  ...
  "enterprise.faq.q1": "Numasec Enterprise nedir?",
  "enterprise.faq.a1":
    "Numasec Enterprise, kodunuzun ve verilerinizin asla altyapınızı terk etmemesini sağlamak isteyen kurumlar içindir. Bunu, SSO'nuz ve dahili AI geçidiniz ile entegre olan merkezileştirilmiş bir konfigürasyonla sağlar.",
  "enterprise.faq.q2": "Numasec Enterprise'a nasıl başlarım?",
  "enterprise.faq.a2":
    "Ekibinizle dahili bir deneme ile başlayın. Numasec varsayılan olarak kodunuzu veya bağlam verilerinizi saklamaz, bu da başlamayı kolaylaştırır. Ardından fiyatlandırma ve uygulama seçeneklerini görüşmek için bize ulaşın.",
  ...
  "enterprise.faq.q4": "Numasec Enterprise ile verilerim güvende mi?",
  "enterprise.faq.a4":
    "Evet. Numasec kodunuzu veya bağlam verilerinizi saklamaz. Tüm işleme yerel olarak ya da AI sağlayıcınıza doğrudan API çağrıları ile gerçekleştirilir. Merkezileştirilmiş konfigürasyon ve SSO entegrasyonu ile verileriniz kurumunuzun altyapısı içinde güvende kalır.",

  "brand.title": "Numasec | Marka",
  "brand.meta.description": "Numasec marka kılavuzu",
  "brand.heading": "Marka kılavuzu",
  "brand.subtitle": "Numasec markası ile çalışmanıza yardımcı olacak kaynaklar ve varlıklar.",
  "brand.downloadAll": "Tüm varlıkları indir",

  "changelog.title": "Numasec | Değişiklik günlüğü",
  "changelog.meta.description": "Numasec sürüm notları ve değişiklik günlüğü",
  "changelog.hero.title": "Değişiklik günlüğü",
  "changelog.hero.subtitle": "Numasec için yeni güncellemeler ve iyileştirmeler",
