...
export const dict = {
  ...
  "notFound.title": "Не найдено | numasec",
  "notFound.heading": "404 - Страница не найдена",
  "notFound.home": "Главная",
  "notFound.docs": "Документация",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "светлый логотип numasec",
  "notFound.logoDarkAlt": "темный логотип numasec",
  ...
  "app.meta.description": "Numasec - AI-агент с открытым кодом для программирования.",

  "home.title": "Numasec | AI-агент с открытым кодом для программирования",

  "temp.title": "numasec | AI-агент для программирования в терминале",
  ...
  "temp.feature.zen.afterLink": "от numasec",
  ...
  "temp.screenshot.caption": "Numasec TUI с темой tokyonight",
  "temp.screenshot.alt": "Numasec TUI с темой tokyonight",
  "temp.logoLightAlt": "светлый логотип numasec",
  "temp.logoDarkAlt": "темный логотип numasec",
  ...
  "home.what.title": "Что такое Numasec?",
  "home.what.body":
    "Numasec — это агент с открытым исходным кодом, который помогает писать код в терминале, IDE или на десктопе.",
  ...
  "home.growth.body":
    "С более чем <strong>{{stars}}</strong> звезд на GitHub, <strong>{{contributors}}</strong> контрибьюторов и <strong>{{commits}}</strong> коммитов, Numasec доверяют более <strong>{{monthlyUsers}}</strong> разработчиков ежемесячно.",
  ...
  "home.privacy.body":
    "Numasec не хранит ваш код или контекстные данные, поэтому он может работать в средах, чувствительных к приватности.",
  "home.privacy.learnMore": "Подробнее о",
  "home.privacy.link": "приватности",

  "home.faq.q1": "Что такое Numasec?",
  "home.faq.a1":
    "Numasec — это агент с открытым исходным кодом, который помогает писать и запускать код с любой AI-моделью. Доступен как терминальный интерфейс, десктопное приложение или расширение для IDE.",
  "home.faq.q2": "Как использовать Numasec?",
  "home.faq.a2.before": "Проще всего начать с чтения",
  "home.faq.a2.link": "введения",
  "home.faq.q3": "Нужны ли дополнительные подписки на AI для использования Numasec?",
  "home.faq.a3.p1":
    "Не обязательно, Numasec поставляется с набором бесплатных моделей, которые можно использовать без создания аккаунта.",
  "home.faq.a3.p2.beforeZen":
    "Помимо этого, вы можете использовать любые популярные модели для кодинга, создав аккаунт",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Хотя мы рекомендуем использовать Zen, Numasec также работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",
  "home.faq.a3.p4.beforeLocal": "Вы даже можете подключить ваши",
  "home.faq.a3.p4.localLink": "локальные модели",
  "home.faq.q4": "Могу ли я использовать мои существующие AI-подписки с Numasec?",
  "home.faq.a4.p1":
    "Да, Numasec поддерживает подписки всех основных провайдеров. Вы можете использовать ваши подписки Claude Pro/Max, ChatGPT Plus/Pro или GitHub Copilot.",
  "home.faq.q5": "Можно ли использовать Numasec только в терминале?",
  "home.faq.a5.beforeDesktop": "Больше нет! Numasec теперь доступен как приложение для",
  "home.faq.a5.desktop": "десктопа",
  "home.faq.a5.and": "и",
  "home.faq.a5.web": "веба",
  "home.faq.q6": "Сколько стоит Numasec?",
  "home.faq.a6":
    "Numasec на 100% бесплатен. Он также включает набор бесплатных моделей. Дополнительные расходы могут возникнуть, если вы подключите другого провайдера.",
  ...
  "home.faq.q8": "Numasec — это open source?",
  "home.faq.a8.p1": "Да, Numasec полностью open source. Исходный код доступен публично на",
  "home.faq.a8.p2": "под",
  ...
  "home.zenCta.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые Numasec протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве разных провайдеров, используйте проверенные модели, которые работают.",
  "home.zenCta.link": "Узнать о Zen",

  "zen.title": "Numasec Zen | Набор надежных оптимизированных моделей для кодинг-агентов",
  "zen.hero.title": "Надежные оптимизированные модели для кодинг-агентов",
  "zen.hero.body":
    "Zen дает доступ к отобранному набору AI-моделей, которые Numasec протестировал и проверил специально для кодинг-агентов. Не нужно беспокоиться о нестабильной производительности и качестве, используйте проверенные модели, которые работают.",

  "zen.faq.q1": "Что такое Numasec Zen?",
  "zen.faq.a1":
    "Zen — это отобранный набор AI-моделей, протестированных и проверенных для кодинг-агентов командой, стоящей за Numasec.",
  ...
  "zen.faq.a3":
    "Zen — некоммерческий проект. Zen транслирует расходы от провайдеров моделей вам. Чем больше использование Zen, тем лучшие тарифы Numasec может согласовать и передать вам.",
  ...
  "zen.faq.a4.p3":
    "Для покрытия расходов Numasec добавляет лишь небольшую комиссию за обработку платежа в размере $1.23 при пополнении баланса на $20.",
  ...
  "zen.faq.a8":
    "Хотя Zen отлично работает с Numasec, вы можете использовать Zen с любым агентом. Следуйте инструкциям по настройке в вашем любимом агенте.",
  ...
  "zen.problem.subtitle": "Мы исправляем это для всех, а не только для пользователей Numasec.",
  ...
  "zen.how.body": "Хотя мы предлагаем использовать Zen с Numasec, вы можете использовать его с любым агентом.",
  ...
  "go.title": "Numasec Go | Недорогие модели для кодинга для всех",
  "go.meta.description":
  ...
  "go.problem.body":
    "Мы стремимся сделать Numasec доступным для как можно большего числа людей. Numasec Go - это недорогая подписка: $5 за первый месяц, затем $10/месяц. Она предоставляет щедрые лимиты и надежный доступ к самым мощным моделям с открытым исходным кодом.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go начинается с $5 за первый месяц, затем $10/месяц. Вы можете использовать его с Numasec или любым агентом.",
  ...
  "go.faq.q1": "Что такое Numasec Go?",
  "go.faq.a1":
  ...
  "black.meta.title": "Numasec Black | Доступ к лучшим моделям для кодинга в мире",
  "black.meta.description": "Получите доступ к Claude, GPT, Gemini и другим моделям с подпиской Numasec Black.",
  "black.hero.title": "Доступ к лучшим моделям для кодинга в мире",
  "black.hero.subtitle": "Включая Claude, GPT, Gemini и другие",
  "black.title": "Numasec Black | Цены",
  ...
  "black.subscribe.success.title": "Вы в списке ожидания Numasec Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Используйте Zen с любым кодинг-агентом и продолжайте использовать других провайдеров с numasec, когда захотите.",
  ...
  "workspace.newUser.step.login.after": "и выберите numasec",
  "workspace.newUser.step.pasteKey": "Вставьте ваш API ключ",
  "workspace.newUser.step.models.before": "Запустите numasec и выполните",
  ...
  "workspace.keys.subtitle": "Управляйте вашими API ключами для доступа к сервисам numasec.",
  "workspace.keys.create": "Создать API ключ",
  "workspace.keys.placeholder": "Введите название ключа",
  "workspace.keys.empty": "Создайте API ключ для шлюза numasec",
  ...
  "workspace.black.subscription.message": "Вы подписаны на Numasec Black за ${{plan}} в месяц.",
  ...
  "workspace.black.waitlist.joined": "Вы в списке ожидания плана Numasec Black за ${{plan}} в месяц.",
  "workspace.black.waitlist.ready": "Мы готовы подключить вас к плану Numasec Black за ${{plan}} в месяц.",
  ...
  "workspace.lite.subscription.message": "Вы подписаны на Numasec Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Выберите "Numasec Go" в качестве провайдера в настройках numasec для использования моделей Go.',
  "workspace.lite.black.message":
    "Вы подписаны на Numasec Black или находитесь в списке ожидания. Пожалуйста, сначала отмените подписку, если хотите перейти на Go.",
  "workspace.lite.other.message":
    "Другой участник в этом рабочем пространстве уже подписан на Numasec Go. Только один участник в рабочем пространстве может оформить подписку.",
  "workspace.lite.promo.description":
    "Numasec Go начинается с {{price}}, затем $10/месяц и предоставляет надежный доступ к популярным открытым моделям кодирования с щедрыми лимитами использования.",
  ...
  "download.title": "Numasec | Скачать",
  "download.meta.description": "Скачать Numasec для macOS, Windows и Linux",
  "download.hero.title": "Скачать Numasec",
  ...
  "download.section.extensions": "Расширения Numasec",
  "download.section.integrations": "Интеграции Numasec",
  ...
  "download.faq.a3.beforeLocal":
    "Не обязательно, но возможно. Вам понадобится AI подписка, если вы хотите подключить Numasec к платному провайдеру, хотя вы можете работать с",
  ...
  "download.faq.a3.afterZen":
    ", Numasec работает со всеми популярными провайдерами, такими как OpenAI, Anthropic, xAI и др.",

  "download.faq.a5.p1": "Numasec на 100% бесплатен.",
  "download.faq.a5.p2.beforeZen":
    "Любые дополнительные расходы будут связаны с вашей подпиской у провайдера моделей. Хотя Numasec работает с любым провайдером моделей, мы рекомендуем использовать",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Ваши данные и информация сохраняются только при создании ссылок для шеринга в Numasec.",
  "download.faq.a6.p2.beforeShare": "Подробнее о",
  "download.faq.a6.shareLink": "страницах шеринга",

  "enterprise.title": "Numasec | Корпоративные решения для вашей организации",
  "enterprise.meta.description": "Свяжитесь с Numasec для корпоративных решений",
  "enterprise.hero.title": "Ваш код принадлежит вам",
  "enterprise.hero.body1":
    "Numasec безопасно работает внутри вашей организации: не хранит данные и контекст, без лицензионных ограничений и претензий на собственность. Начните пробный период с командой, затем разверните по всей организации, интегрировав с SSO и внутренним AI-шлюзом.",
  ...
  "enterprise.faq.q1": "Что такое Numasec Enterprise?",
  "enterprise.faq.a1":
    "Numasec Enterprise предназначен для организаций, которые хотят гарантировать, что их код и данные никогда не покинут их инфраструктуру. Это достигается за счет централизованной конфигурации, интегрированной с вашим SSO и внутренним AI-шлюзом.",
  "enterprise.faq.q2": "Как начать работу с Numasec Enterprise?",
  "enterprise.faq.a2":
    "Просто начните с внутреннего триала с вашей командой. Numasec по умолчанию не хранит ваш код или контекстные данные, поэтому начать легко. Затем свяжитесь с нами, чтобы обсудить цены и варианты внедрения.",
  ...
  "enterprise.faq.q4": "Безопасны ли мои данные с Numasec Enterprise?",
  "enterprise.faq.a4":
    "Да. Numasec не хранит ваш код или контекстные данные. Вся обработка происходит локально или через прямые вызовы API к вашему AI-провайдеру. Благодаря централизованной конфигурации и интеграции SSO ваши данные остаются защищенными внутри инфраструктуры вашей организации.",

  "brand.title": "Numasec | Бренд",
  "brand.meta.description": "Гайдлайны бренда Numasec",
  "brand.heading": "Гайдлайны бренда",
  "brand.subtitle": "Ресурсы и активы, которые помогут вам работать с брендом Numasec.",
  "brand.downloadAll": "Скачать все ресурсы",

  "changelog.title": "Numasec | Список изменений",
  "changelog.meta.description": "Примечания к релизам и список изменений Numasec",
  "changelog.hero.title": "Список изменений",
  "changelog.hero.subtitle": "Новые обновления и улучшения Numasec",
