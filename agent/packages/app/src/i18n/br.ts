export const dict = {
  ...
  "dialog.provider.numasec.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.numasec.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.numasecGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Numasec",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Numasec.",
  ...
  "provider.connect.numasecZen.line1":
    "Numasec Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.numasecZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.numasecZen.visit.prefix": "Visite ",
  "provider.connect.numasecZen.visit.link": "numasec.ai/zen",
  "provider.connect.numasecZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Numasec.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Numasec.",
  ...
  "dialog.plugins.empty": "Plugins configurados em numasec.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Numasec este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Numasec ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Numasec",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (numasec.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Numasec ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Numasec inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Numasec dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Numasec",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Numasec aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Numasec segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Numasec é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Numasec iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Numasec.",
