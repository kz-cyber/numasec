...
export const dict = {
  ...
  "dialog.provider.numasec.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.numasec.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.numasecGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "Numasec tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Numasec'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.numasecZen.line1":
    "Numasec Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.numasecZen.visit.prefix": "",
  "provider.connect.numasecZen.visit.link": "numasec.ai/zen",
  "provider.connect.numasecZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Numasec'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Numasec'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler numasec.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Numasec sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Numasec'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Numasec ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (numasec.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Numasec henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Numasec ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "settings.general.row.language.description": "Numasec'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Numasec'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Numasec'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Numasec'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Numasec başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Numasec'un en son sürümünü kullanıyorsunuz.",
