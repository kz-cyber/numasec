...
export const dict = {
  ...
  "dialog.provider.numasec.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.numasec.tagline": "可靠的優化模型",
  "dialog.provider.numasecGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "Numasec 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Numasec 中使用 {{provider}} 模型。",
  ...
  "provider.connect.numasecZen.line1": "Numasec Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.numasecZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.numasecZen.visit.prefix": "造訪 ",
  "provider.connect.numasecZen.visit.link": "numasec.ai/zen",
  "provider.connect.numasecZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Numasec 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Numasec 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 numasec.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 Numasec 伺服器。",
  ...
  "toast.update.description": "Numasec 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Numasec 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (numasec.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: Numasec 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Numasec 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Numasec 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Numasec 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Numasec 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Numasec 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Numasec 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Numasec。",
