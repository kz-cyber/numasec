export const dict = {
  ...
  "dialog.provider.numasec.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.numasec.tagline": "Modèles optimisés et fiables",
  "dialog.provider.numasecGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Numasec",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Numasec.",
  ...
  "provider.connect.numasecZen.line1":
    "Numasec Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.numasecZen.visit.prefix": "Visitez ",
  "provider.connect.numasecZen.visit.link": "numasec.ai/zen",
  "provider.connect.numasecZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Numasec.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Numasec.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans numasec.json",
  ...
  "dialog.server.description": "Changez le serveur Numasec auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Numasec ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Numasec",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (numasec.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Numasec ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Numasec inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Numasec dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Numasec",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Numasec sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Numasec suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Numasec.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Numasec",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Numasec.",
