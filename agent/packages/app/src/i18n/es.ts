export const dict = {
  ...
  "dialog.provider.numasec.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.numasec.tagline": "Modelos optimizados y fiables",
  "dialog.provider.numasecGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Numasec",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Numasec.",
  ...
  "provider.connect.numasecZen.line1":
    "Numasec Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.numasecZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.numasecZen.visit.prefix": "Visita ",
  "provider.connect.numasecZen.visit.link": "numasec.ai/zen",
  "provider.connect.numasecZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Numasec.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Numasec.",
  ...
  "dialog.plugins.empty": "Plugins configurados en numasec.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Numasec se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Numasec ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Numasec",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (numasec.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Numasec no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Numasec incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Numasec dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Numasec",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Numasec en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Numasec sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Numasec.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Numasec",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Numasec.",
