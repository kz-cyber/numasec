export const dict = {
  ...
  "dialog.provider.numasec.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.numasec.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.numasecGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Numasec",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Numasec.",
  ...
  "provider.connect.numasecZen.line1":
    "Numasec Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.numasecZen.visit.prefix": "Odwiedź ",
  "provider.connect.numasecZen.visit.link": "numasec.ai/zen",
  "provider.connect.numasecZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Numasec.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Numasec.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w numasec.json",
  ...
  "dialog.server.description": "Przełącz serwer Numasec, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Numasec ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Numasec",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (numasec.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "Numasec zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Numasec",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Numasec na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Numasec ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Numasec.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Numasec",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Numasec.",
