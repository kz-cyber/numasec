...
export const dict = {
  ...
  "dialog.provider.numasec.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.numasec.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.numasecGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Numasec",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Numasec.",
  ...
  "provider.connect.numasecZen.line1":
    "Numasec Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.numasecZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.numasecZen.visit.prefix": "Besøk ",
  "provider.connect.numasecZen.visit.link": "numasec.ai/zen",
  "provider.connect.numasecZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Numasec.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Numasec.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i numasec.json",
  ...
  "dialog.server.description": "Bytt hvilken Numasec-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Numasec ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Numasec-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (numasec.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Numasec ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Numasec inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Numasec-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Numasec",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Numasec ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om Numasec skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Numasec er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Numasec starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Numasec.",
