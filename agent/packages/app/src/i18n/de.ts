...
export const dict = {
  ...
  "dialog.provider.numasec.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.numasec.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.numasecGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Numasec",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Numasec zu nutzen.",
  ...
  "provider.connect.numasecZen.line1":
    "Numasec Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Security-Agenten.",
  ...
  "provider.connect.numasecZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.numasecZen.visit.link": "numasec.ai/zen",
  "provider.connect.numasecZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Numasec zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Numasec zu nutzen.",
  ...
  "dialog.plugins.empty": "In numasec.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Numasec-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Numasec ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Numasec-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (numasec.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Numasec unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Numasec enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Numasec-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Numasec ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Numasec auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Numasec dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Numasec anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Numasec automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Numasec.",
