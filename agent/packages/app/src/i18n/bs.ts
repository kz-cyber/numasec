export const dict = {
  ...
  "dialog.provider.numasec.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.numasec.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.numasecGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Numasec",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Numasec-u.",
  ...
  "provider.connect.numasecZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Numasec-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Numasec-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u numasec.json",
  ...
  "dialog.server.description": "Promijeni na koji se Numasec server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Numasec-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Numasec timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (numasec.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Numasec još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Numasec uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Numasec-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Numasec izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Numasec prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Numasec-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Numasec pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Numasec-a.",
