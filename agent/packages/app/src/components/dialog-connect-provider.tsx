import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@numasec/sdk/v2/client"
import { Button } from "@numasec/ui/button"
import { useDialog } from "@numasec/ui/context/dialog"
import { Dialog } from "@numasec/ui/dialog"
import { Icon } from "@numasec/ui/icon"
import { IconButton } from "@numasec/ui/icon-button"
import { List, type ListRef } from "@numasec/ui/list"
import { ProviderIcon } from "@numasec/ui/provider-icon"
import { Spinner } from "@numasec/ui/spinner"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "numasec"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.numasecZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.numasecZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.numasecZen.visit.prefix")}
                <Link href="https://numasec.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.numasecZen.visit.link")}
                </Link>
                {language.t("provider.connect.numasecZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
