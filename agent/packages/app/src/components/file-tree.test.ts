...
beforeAll(async () => {
  ...
  mock.module("@numasec/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@numasec/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@numasec/ui/icon", () => ({ Icon: () => null }))
  mock.module("@numasec/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
