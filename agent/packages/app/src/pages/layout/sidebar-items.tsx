import type { Message, Session, TextPart, UserMessage } from "@numasec/sdk/v2/client"
import { Avatar } from "@numasec/ui/avatar"
import { HoverCard } from "@numasec/ui/hover-card"
...
import { base64Encode } from "@numasec/util/encode"
...
const NUMASEC_PROJECT_ID = "4b0ea68d7af9a6031a7ffda7ad66e0cb83315750"
    ...
    <div class={`relative size-8 shrink-0 rounded ${props.class ?? ""}`}>
      <div class="size-full rounded overflow-clip">
        <Avatar
          fallback={name()}
          src={
            props.project.id === NUMASEC_PROJECT_ID ? "https://numasec.ai/favicon.svg" : props.project.icon?.override
          }
