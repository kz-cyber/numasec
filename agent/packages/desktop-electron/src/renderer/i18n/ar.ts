export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Numasec",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Numasec، هل ترغب في تثبيته وإعادة تشغيله؟",
