export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Numasec",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Numasec. ¿Quieres instalarla y reiniciar?",
