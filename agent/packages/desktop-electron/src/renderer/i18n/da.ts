export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Numasec",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Numasec er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'numasec'-kommandoen.",
