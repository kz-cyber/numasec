...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    },
    {
      label: "Help",
      submenu: [
        { label: "Numasec Documentation", click: () => shell.openExternal("https://numasec.ai/docs") },
        { label: "Support Forum", click: () => shell.openExternal("https://discord.com/invite/numasec") },
        { type: "separator" },
        { type: "separator" },
        {
          label: "Share Feedback",
          click: () =>
            shell.openExternal("https://github.com/anomalyco/numasec/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/anomalyco/numasec/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
