...
import type { AssistantMessage, Part, ToolPart, UserMessage, TextPart, ReasoningPart } from "@numasec/sdk/v2"
...
import { EvidenceBrowser } from "../../component/evidence-browser"
...
export function Session() {
  ...
  command.register(() => [
    ...
    },
    {
      ...
      onSelect: (dialog) => {
        dialog.replace(() => <EvidenceBrowser sessionID={route.sessionID} />)
      },
    },
  ])
