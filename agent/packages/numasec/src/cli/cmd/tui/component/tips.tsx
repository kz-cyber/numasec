...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at numasec.ai",
  ...
  "Run {highlight}/init{/highlight} to auto-generate security rules based on your target application",
  ...
  "Numasec auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Numasec auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Numasec uses LSP servers for intelligent code analysis",
  "Create {highlight}.ts{/highlight} files in {highlight}.numasec/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}.numasec/plugin/{/highlight} for event hooks",
  "Use plugins to send OS notifications when sessions complete",
  "Create a plugin to prevent Numasec from reading sensitive files",
  "Use {highlight}numasec run{/highlight} for non-interactive scripting",
  "Use {highlight}numasec --continue{/highlight} to resume the last session",
  "Use {highlight}numasec run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}numasec serve{/highlight} for headless API access to Numasec",
  "Use {highlight}numasec run --attach{/highlight} to connect to a running server",
  "Run {highlight}numasec upgrade{/highlight} to update to the latest version",
  "Run {highlight}numasec auth list{/highlight} to see all configured providers",
  "Run {highlight}numasec agent create{/highlight} for guided agent creation",
  "Use {highlight}/numasec{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}numasec github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/numasec fix this{/highlight} on issues to auto-create PRs",
  "Comment {highlight}/numasec{/highlight} on PR code lines for targeted security reviews",
  ...
  "Run {highlight}numasec debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/numasec{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with Numasec Zen for curated, tested models",
