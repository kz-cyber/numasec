...
import { createOpencodeClient, type Message, type OpencodeClient, type ToolPart } from "@numasec/sdk/v2"
...
export const RunCommand = cmd({
  ...
  handler: async (args) => {
    ...
    await bootstrap(process.cwd(), async () => {
      ...
      const sdk = createOpencodeClient({ baseUrl: "http://numasec.internal", fetch: fetchFn })
      await execute(sdk)
    })
  },
})
