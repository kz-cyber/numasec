...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/numasec.git")).toEqual({ owner: "sst", repo: "numasec" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/numasec")).toEqual({ owner: "sst", repo: "numasec" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/numasec.git")).toEqual({ owner: "sst", repo: "numasec" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/numasec")).toEqual({ owner: "sst", repo: "numasec" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/numasec.git")).toEqual({ owner: "sst", repo: "numasec" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/numasec")).toEqual({ owner: "sst", repo: "numasec" })
})
