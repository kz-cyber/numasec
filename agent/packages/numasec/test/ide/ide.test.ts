...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders NUMASEC_CALLER", () => {
    process.env["NUMASEC_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode NUMASEC_CALLER", () => {
    process.env["NUMASEC_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown NUMASEC_CALLER", () => {
    process.env["NUMASEC_CALLER"] = "unknown"
