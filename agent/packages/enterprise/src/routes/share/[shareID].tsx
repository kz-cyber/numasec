import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@numasec/sdk/v2"
import { SessionTurn } from "@numasec/ui/session-turn"
import { SessionReview } from "@numasec/ui/session-review"
import { DataProvider } from "@numasec/ui/context"
import { FileComponentProvider } from "@numasec/ui/context/file"
import { WorkerPoolProvider } from "@numasec/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@numasec/ui/logo"
import { IconButton } from "@numasec/ui/icon-button"
import { ProviderIcon } from "@numasec/ui/provider-icon"
import { iife } from "@numasec/util/iife"
...
import { Tabs } from "@numasec/ui/tabs"
import { MessageNav } from "@numasec/ui/message-nav"
import { FileSSR } from "@numasec/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@numasec/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/numasec-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/numasec"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
