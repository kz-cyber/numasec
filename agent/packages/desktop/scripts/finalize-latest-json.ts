...
const releaseId = process.env.NUMASEC_RELEASE
if (!releaseId) throw new Error("NUMASEC_RELEASE is required")

const version = process.env.NUMASEC_VERSION
if (!releaseId) throw new Error("NUMASEC_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "numasec-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "numasec-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "numasec-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "numasec-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "numasec-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "numasec-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "numasec-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "numasec-desktop-darwin-aarch64.app.tar.gz",
  },
]
