export const dict = {
  ...
  "desktop.menu.help.documentation": "Numasec Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Numasec CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
